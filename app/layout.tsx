...
import ActiveSectionContextPtovider from '@/context/active-section-context'
...
export const metadata: Metadata = {
  title: 'Andriy | Portfolio',
  description: 'Andriy junior front-end developer',
}
  ...
  return (
    <html lang="en" className='!scroll-smooth'>
      ...
      bg-gray-50 text-gray-950 relative pt-28 sm:pt-36 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90`}>
        ...
        <div className='bg-[#dbd7fb] absolute -z-10 top-[-1rem] left-[-35rem] h-[31.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] 
        md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-[#676394]'></div>
        <ThemeContextProvider>
          <ActiveSectionContextPtovider>
            <Header />
            {children}
            <Footer />
