...
export default function Intro() {
  ...
  return (
    <section ref={ref} className='max-w-[50rem] text-center scroll-m-40 mb-28 sm:mb-40' id='home'>
      ...
      >
        <span className="font-bold">Hello, I'm Andriy.</span> I'm a{" "}
        <span className="font-bold">front-en developer</span> with{" "}
      ...
      >
        ...
        outline-none focus:scale-110 hover:scale-110 active:scale-105 transition group
